...
/// Spec section 22 "Collections": Today's Collections / by Representative /
/// by Customer — same aggregate query grouped differently, mirroring
/// [SalesReportScreen]'s single-screen-with-group-by-selector approach.
...
class _CollectionsReportScreenState extends ConsumerState<CollectionsReportScreen> {
  ...
  Future<ReportSummary> _load() {
    return ref.read(reportsRepositoryProvider).collections(from: _isoDate(_from), to: _isoDate(_to), groupBy: _groupBy);
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: Text(l10n.reportsCollections)),
            ...
            children: [
              ...
              Expanded(
                child: switch (snapshot.connectionState) {
                  ...
                  ConnectionState.done when snapshot.hasData => _CollectionsReportBody(report: snapshot.data!, isArabic: isArabic),
...
class _CollectionsReportBody extends StatelessWidget {
  const _CollectionsReportBody({required this.report, required this.isArabic});
              ...
              child: Row(
                ...
                children: [
                  Column(
                    ...
                    children: [
                      Text(l10n.reportPaymentCount, style: Theme.of(context).textTheme.bodySmall),
              ...
              : ListView.separated(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return Card(
                      child: ListTile(
                        title: Text(label),
                        subtitle: row.count != null ? Text('${row.count} ${l10n.reportPaymentCount}') : null,
                ...
                Expanded(
                  child: OutlinedButton.icon(
                    onPressed: () async {
                      ...
                      await Printing.sharePdf(bytes: await doc.save(), filename: 'collections_report.pdf');
                    },
  ...
  Future<pw.Document> _buildPdf(AppLocalizations l10n) {
    return PdfBuilder.genericReport(
      ...
      headers: [l10n.reportGroupBy, l10n.reportPaymentCount, l10n.reportTotal],
      rows: report.rows
          .map((r) => [
          ...
          .toList(),
      summary: [
        MapEntry(l10n.reportPaymentCount, '${report.count ?? 0}'),
